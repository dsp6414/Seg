...
parser.add_argument('--check_dir', default='./parameters_sgd')  # save checkpoint parameters
parser.add_argument('--q', default='resnet50')  # save checkpoint parameters
parser.add_argument('--b', type=int, default=80)  # batch size
